...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 1) {
        ...
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"APP开发者：洪清\n邮箱:15632682003@163.com" message:nil delegate:self cancelButtonTitle:nil otherButtonTitles:@"确定", nil];
        [alert show];
    }
